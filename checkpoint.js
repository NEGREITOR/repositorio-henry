...
function mayorMenor(numeros) {
  ...
  for (var i = 0; i < numeros.length; i++) {
    arreglo[1] = Math.max.apply(Math,numeros);
    arreglo[0] = Math.min.apply(Math,numeros);
    }
  return arreglo;
}
  ...
  class Viajero {
    ...
    getCompañeros() {
      ...
      for (var i = 0; i < this.compañeros.length; i++) {
        compaName.push(this.compañeros[i]["nombre"]);        
      }
      return compaName;
    }
    ...
    getPromedioEdad() {
      ...
      var contador = 0;
      for (var i = 0; i < this.compañeros.length; i++) {
        contador = contador + this.compañeros[i]["edad"];       
        resultado = contador / this.compañeros.length;
      }
      return resultado;
    }
  };
